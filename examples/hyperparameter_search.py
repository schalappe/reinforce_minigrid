...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", type=str, default="examples/configs/a2c_search.yaml", help="Path to the search configuration file"
    )
    ...
    if not os.path.exists(args.config):
        ...
        search_config = {
            ...
            "hyperparameters": {
                "agent.learning_rate": {"type": "float", "low": 0.0001, "high": 0.01, "log_scale": True},
                "agent.entropy_coef": {"type": "float", "low": 0.001, "high": 0.1, "log_scale": True},
                "agent.discount_factor": {"type": "categorical", "values": [0.9, 0.95, 0.99]},
                "agent.embedding_size": {"type": "int", "low": 64, "high": 256},
            },
        }
